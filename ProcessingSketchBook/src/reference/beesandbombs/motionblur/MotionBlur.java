package reference.beesandbombs.motionblur;
...
public class MotionBlur extends PApplet{
	...
	int samplesPerFrame = 8;  // more is better but slower. 32 is enough probably
	int numFrames = 32;        
	float shutterAngle = 4.50f;  // this should be between 0 and 1 realistically. exaggerated for effect here
	int[][] result;
...
//	    exit();
	...
	public static void main(String _args[]) {
		...
		PApplet.main(reference.beesandbombs.motionblur.MotionBlur.class.getName());
	}
